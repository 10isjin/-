            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className={`font-bold truncate ${index === 0 ? 'text-yellow-700' : 'text-slate-900'}`}>
                    {runner.displayName}
                  </span>
                  {runner.studentId ? (
                  ...
                  {index < 3 && <Trophy size={12} className={
              ...
              <div className="text-right shrink-0">
                <span className={`text-xl font-black number-font tracking-tighter transition-colors ${
                  index === 0 ? 'text-yellow-600' : 'text-slate-900 group-hover:text-emerald-600'
                }`}>
